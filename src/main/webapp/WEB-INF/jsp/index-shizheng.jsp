...
<div class="head-box">
    <div class="head-content">
        <div class="action-menu">
            <a href="${path}/xinwen/index" class="tb ">全部</a>
            <a href="${path}/xinwen/shizheng" class="tb active">时政</a>
                ...
                <div class="body-login" style="border-radius:0 0 0 5px;">
                    <div class="box-mobilelogin">
                        <form name="login-form" class="form-mobilelogin" action="#" autocomplete="on">
                            <div class="pr"><input type="text" name="username" id="mobile" placeholder="用户名" class="mobile" tabindex="1"></div>
                            <div class="pr"><input type="password" name="password" id="mbpwd" placeholder="密码" class="mbpwd" tabindex="2"></div>
                        </form>
                    </div>
                    <div class="box-btn">
            ...
            <div class="body-register" style="border-radius:0 0 5px 0;">
                <form action="" name="userForm">
                    <div class="box-register-mobile">
                        <div class="pr">
                            <input type="text" name="username" placeholder="账户" class="rgcode">
                        </div>
                        <div class="pr">
                            <input type="password" name="password" placeholder="密码" class="rgpwd">
                        </div>
                        <div>
